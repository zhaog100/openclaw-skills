...
#!/usr/bin/env python3
"""
Algora Bounty 监控脚本（v7.5.6 - 增强健壮性）
...
STATE_FILE = Path(tempfile.gettempdir()) / 'algora-bounty-state.json'
...
NEED_WALLET_CONFIG = not WALLET_ADDRESS or WALLET_ADDRESS.startswith('0x')
