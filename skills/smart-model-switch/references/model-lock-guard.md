...
**适用于所有模型厂商**：百炼、智谱、LongCat、OpenRouter 等都可能遇到。
...
### 关键特性
- **厂商无关**：适用于百炼、智谱、LongCat、OpenRouter 等所有厂商
...
Fallback链：
 1. bailian/qwen3-max-2026-01-23    ← 百炼
 2. bailian/qwen3-coder-next         ← 百炼
 3. bailian/glm-5                    ← 百炼
 4. bailian/glm-4.7                  ← 百炼
 5. bailian/MiniMax-M2.5             ← 百炼
 6. zai/glm-5.1                      ← 智谱
 7. zai/glm-5                        ← 智谱
 8. zai/glm-4.7                      ← 智谱
 9. zai/glm-4.7-flash                ← 智谱
10. longcat/LongCat-Flash-Lite       ← LongCat
```

**注意**：同一厂商的模型会一起被限速（共享 API Key 配额）。
...
4. 守护脚本适用于所有 OpenClaw 实例（小米辣、小米椒、小米粒等）
