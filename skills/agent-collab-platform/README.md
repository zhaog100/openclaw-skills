...
#### origin仓库（公共仓库）
- **URL**：`git@github.com:example-user/openclaw-skills.git`
- **用途**：公共信息，所有智能体遵守的规则
...
#### xiaomili仓库（小米粒个人仓库）
- **URL**：`https://github.com/example-user/xiaomili-skills.git`
- **用途**：小米粒（Dev代理）的个人信息
...
#### xiaomila仓库（小米粒个人仓库）
- **URL**：`https://github.com/example-user/xiaomila-skills.git`
- **用途**：小米粒（PM代理）的个人信息
