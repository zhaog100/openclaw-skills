...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/example-user/openclaw-skills)
...
```bash
git clone https://github.com/example-user/openclaw-skills
...
Copyright (c) 2026 思捷娅科技 (xiaomili)
...
- **GitHub**: https://github.com/example-user/openclaw-skills
- **ClawHub**: https://clawhub.com
- **Issue**: https://github.com/example-user/openclaw-skills/issues
