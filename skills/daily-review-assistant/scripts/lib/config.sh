...
# 默认配置值
DEFAULT_WORKSPACE="/home/zhaog/.openclaw/workspace"
...
load_config() {
    ...
    if command -v jq &> /dev/null; then
        ...
        CFG_QQBOT_ID=$(jq -r '.notifications.qqbot_id' "$CONFIG_FILE" 2>/dev/null || echo "C099848DC9A60BF60A7BE31626822790")
...
use_default_config() {
    ...
    CFG_QQBOT_ID="C099848DC9A60BF60A7BE31626822790"
