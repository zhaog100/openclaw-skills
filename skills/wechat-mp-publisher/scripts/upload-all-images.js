...
async function uploadAllImagesAndPublish() {
  console.log('🖼️ 开始上传所有图片到微信服务器...');
  ...
  try {
    ...
    for (const img of images) {
      ...
      // 截图
      const imagePath = `/tmp/wechat-img-${img.name}.png`;
      ...
      formData.append('media', new Blob([imageBuffer]), `img-${img.name}.png`);
...
uploadAllImagesAndPublish().then(result => {
