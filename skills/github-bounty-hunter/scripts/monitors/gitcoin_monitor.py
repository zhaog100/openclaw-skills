...
class GitcoinMonitor:
    def __init__(self):
        ...
        self.state_file = Path(tempfile.gettempdir()) / 'gitcoin-bounty-state.yaml'
        self.notify_dir = Path(tempfile.gettempdir()) / 'github-bounty-notifies'
...
---
*由 github-bounty-hunter v7.5.6 自动发送 | 版权：思捷娅科技 (SJYKJ)*"""
