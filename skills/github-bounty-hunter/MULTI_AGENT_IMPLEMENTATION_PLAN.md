...
**实现**:
```bash
openclaw agents add xiaomila-pm --workspace /home/<user>/.openclaw/workspace/agents/xiaomila-pm
openclaw agents add xiaomila-dev --workspace /home/<user>/.openclaw/workspace/agents/xiaomila-dev
```
