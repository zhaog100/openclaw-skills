...
5. **手动加载自定义技能**（不在 available_skills 里的）：
   - `read /root/.openclaw/workspace/skills/miliger-context-manager/SKILL.md`
   - `read /root/.openclaw/workspace/skills/quote-reader/SKILL.md`
   - `read /root/.openclaw/workspace/skills/terminal-ocr/SKILL.md`
