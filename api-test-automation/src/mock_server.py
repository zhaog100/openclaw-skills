...
class MockRoute:
    ...
    def with_method(self, http_method: str):
        """Set HTTP method."""
        self.method = http_method.upper()
        return self
    
    def with_path(self, path_pattern: str):
        """Set path pattern."""
        self.path = path_pattern
        return self
    
    def with_response(self, status: int, body: Any = None, headers: Optional[Dict] = None):
        """Set response."""
    ...
    def with_delay(self, seconds: float):
        """Set response delay."""
        self.delay = seconds
        return self
